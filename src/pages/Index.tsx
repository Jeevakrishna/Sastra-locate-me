...
const Index = () => {
  ...
  const locationCards: LocationCard[] = [
    { id: 1, title: "Academic Building", locations: 2, color: "bg-card-red", image: "/grid-uploads/sastra-photo.png" },
    { id: 2, title: "Academic Building", locations: 2, color: "bg-card-blue", image: "/grid-uploads/sastra-photo.png" },
    { id: 3, title: "Academic Building", locations: 2, color: "bg-card-yellow", image: "/grid-uploads/sastra-photo.png" },
    { id: 4, title: "Academic Building", locations: 2, color: "bg-card-green", image: "/grid-uploads/sastra-photo.png" },
    { id: 5, title: "Academic Building", locations: 2, color: "bg-card-purple", image: "/grid-uploads/sastra-photo.png" },
    { id: 6, title: "Academic Building", locations: 2, color: "bg-card-navy", image: "/grid-uploads/sastra-photo.png" },
    { id: 7, title: "Academic Building", locations: 2, color: "bg-card-orange", image: "/grid-uploads/sastra-photo.png" },
    { id: 8, title: "Academic Building", locations: 2, color: "bg-card-pink", image: "/grid-uploads/sastra-photo.png" },
    { id: 9, title: "Academic Building", locations: 2, color: "bg-card-emerald", image: "/grid-uploads/sastra-photo.png" },
  ];
  ...
  return (
    <div 
      ...
      style={{ backgroundImage: "url('#')" }}  // public/grid-uploads/sastra-photo.png
    >
